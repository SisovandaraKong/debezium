...
- GitHub Issues: [Your Issue Tracker]
- Email: [Your Email]
...
- [ ] Archive log mode enabled: `ARCHIVELOG`
- [ ] Supplemental logging enabled: `YES | YES`
- [ ] CDC user exists and can connect
- [ ] Kafka brokers are running (3 nodes)
- [ ] Schema Registry is accessible
- [ ] OpenLogReplicator connected to Oracle
- [ ] OpenLogReplicator listening on port 8080
- [ ] Debezium Kafka Connect REST API responds
- [ ] Connector status is `RUNNING`
- [ ] Kafka topic created: `oracle_server.C__DBZUSER.CUSTOMERS`
- [ ] Initial snapshot completed (4 events)
- [ ] Real-time changes appear in Kafka (test with INSERT)
- [ ] Kafka UI accessible at http://localhost:18000

---

**🎉 Congratulations! Your CDC pipeline is now operational!**
